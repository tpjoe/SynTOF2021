...
mc <- as.data.frame(fread('R_py_exchange/mcResultsDWH_allGroups_maxK40_allLowNoPresynaptic_LowNo_08312020Batch210_105_Adagradlr01_noStd_sess_1.csv'))
hidden <- as.data.frame(fread('R_py_exchange/hidden_allLowNoPresynaptic_LowNo_08312020Batch210_105_Adagradlr01_noStd_sess_1.csv', nrows=100000)[-1])
