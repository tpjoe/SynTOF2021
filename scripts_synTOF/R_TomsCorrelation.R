...
eaat_dlcau <- df_lowno[, (grepl('PHF-tau', colnames(df_lowno))) & (grepl(paste0(region, ', '), colnames(df_lowno)))]
gfap_dlcau <- df_lowno[,  (grepl('CD47', colnames(df_lowno))) & (grepl(paste0(region, ', '), colnames(df_lowno)))]

eaat_dlcau <- as.vector(as.matrix(eaat_dlcau))
gfap_dlcau <- as.vector(as.matrix(gfap_dlcau))

cor.test(eaat_dlcau, gfap_dlcau, method='spearman')
