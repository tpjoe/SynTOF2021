...
def predict(identifier, x_train, i):
    ...
    disabling_blas()
    save_dir = '../results_ae/'
    megaAE = tf.keras.models.load_model(save_dir + '/megaAE2_' + identifier + '_' + str(i) + '.h5', 
...
def fit_predict(x_train, identifier, dims, n_clusters_list, i):
    ...
    megaAE.save(save_dir + '/megaAE2_' + identifier + '_' + str(i) + '.h5')
...
identifier = 'allLowNoPresynaptic_LowNo_08312020Batch210_105_Adagradlr01_noStd'
...
to_R.to_csv('R_py_exchange/presynTOF' + identifier_pred + '_sess_' + str(sess) + '.csv')
...
to_R.to_csv('R_py_exchange/postsynTOF' + identifier_pred + '_sess_' + str(sess) + '.csv')
